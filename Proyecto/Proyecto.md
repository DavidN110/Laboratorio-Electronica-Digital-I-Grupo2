...
Tiene una frecuencia de 50Mhz y es un dispositivo lógico programable desarrollado por Altera (ahora parte de Intel) que pertenece a la serie Cyclone IV de FPGAs. Se tiene que instalar una version de Quartus para programarla
